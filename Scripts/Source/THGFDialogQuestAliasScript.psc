Scriptname THGFDialogQuestAliasScript extends ReferenceAlias  
...
Event OnUpdateGameTime()
     ...
     If Self.GetActorRef().GetActorValue("WaitingforPlayer") == 1
          ...
          (GetOwningQuest() as THGFDialogQuestScript).DismissFollower(0,0)
     EndIf
EndEvent
...
Event OnUnload()
     ...
     If Self.GetActorReference().GetActorValue("WaitingforPlayer") == 1
          (GetOwningQuest() as THGFDialogQuestScript).FollowerWait()
     EndIf
EndEvent
